...
inline void 		InitString					(SCInputRef in, const char* name, const char* def)
{
  in.Name = name;
  in.SetString(def);
}
inline void 		InitChart					(SCInputRef in, const char* name, int defChartNum = 1)
{
  in.Name = name;
  in.SetChartNumber(defChartNum);
}

//////////////////////////////////////////////////////////////////////////////////////////////////////// 5) SCFloatArray / séries
inline int 			SeriesSize					(const SCFloatArrayRef arr)							  // Taille d'une série float (SCFloatArray)
{
  return arr.GetArraySize();
}
inline int 			ArraySize					(const SCFloatArrayRef arr)							  // Alias rétro-compatible
{
  return SeriesSize(arr);
}
...
inline bool 		GetBidEntry					(const SCStudyInterfaceRef sc,
                        int level,
                        s_MarketDepthEntry& e)
{
  return sc.GetBidMarketDepthEntryAtLevel(e, level) != 0;
}
inline bool 		GetAskEntry					(const SCStudyInterfaceRef sc,
                        int level,
                        s_MarketDepthEntry& e)
{
  return sc.GetAskMarketDepthEntryAtLevel(e, level) != 0;
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// 7) Time & Sales (accès minimal)
inline bool 		HasTimeAndSales				(const SCStudyInterfaceRef sc)
{
  return sc.MaintainTimeAndSalesData != 0;
}

// Retourne le nombre d'entrées dans out
inline int 			GetTimeAndSales				(const SCStudyInterfaceRef sc,
                           s_TimeAndSalesArray& out)
{
  sc.GetTimeAndSales(out);
  return out.Size();
}

//////////////////////////////////////////////////////////////////////////////////////////////////////// 8) Paramètres "headless" standard pour engines
...
//////////////////////////////////////////////////////////////////////////////////////////////////////// 9) Alertes / logging
inline void			AlertMessage				(SCStudyInterfaceRef sc, const char* msg)
{
  sc.AddAlert(msg);
}
inline void			LogMessage					(SCStudyInterfaceRef sc, const char* msg, int show = 0)
{
  sc.AddMessageToLog(msg, show != 0);
}
