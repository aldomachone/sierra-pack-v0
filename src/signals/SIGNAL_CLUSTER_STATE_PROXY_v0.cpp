#include "sierrachart.h"
  ...
  SCSFExport scsf_SIGNAL_CLUSTER_STATE_PROXY_v0(SCStudyInterfaceRef sc)
  {
    SCSubgraphRef SG = sc.Subgraph[0];

    if (sc.SetDefaults)
    {
      sc.GraphName = "Cluster State proxy v0";
      sc.AutoLoop = 0;
      sc.UpdateAlways = 1;
      sc.GraphRegion = 0;
      sc.ValueFormat = 26;
      ...
      SG.Name = "Cluster State proxy v0";
...
// 3-centroid proxy via seuils sur z-score
...
double Result = (z>1.0)? 1.0 : ((z<-1.0)? -1.0 : 0.0);
