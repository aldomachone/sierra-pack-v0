...
SCSFExport scsf_DOM_IMBAL_ACCUM_DIFF_ENGINE_v0(SCStudyInterfaceRef sc)
{
  static double cum=0;
  if(sc.SetDefaults){
    sc.GraphName="DOM_IMBAL_ACCUM_DIFF_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=1; sc.GraphRegion=0; sc.ValueFormat=26; sc.UsesMarketDepthData=1; sc.FreeDLL=0;
  ...
  int N=sc.Input[0].GetInt(); s_MarketDepthEntry md{}; double b=0,aQ=0;
  ...
  double imb=(b+aQ>0? (b-aQ)/(b+aQ):0.0); cum+=imb;
