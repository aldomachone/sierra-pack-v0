...
SCSFExport scsf_VWAP_CROSSSTATE_ENGINE_v0(SCStudyInterfaceRef sc)
{
  if(sc.SetDefaults){
    sc.GraphName="VWAP_CROSSSTATE_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=0; sc.GraphRegion=0; sc.ValueFormat=26; sc.FreeDLL=0;
  ...
  int idx=sc.ArraySize-1; double px=sc.Close[idx];
  sc.Subgraph[1][idx] = (px>=vwap? +1.0 : -1.0); // state
