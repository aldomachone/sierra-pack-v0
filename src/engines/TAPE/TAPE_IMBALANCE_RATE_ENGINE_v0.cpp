...
SCSFExport scsf_TAPE_IMBALANCE_RATE_ENGINE_v0(SCStudyInterfaceRef sc)
{
  if(sc.SetDefaults){
    sc.GraphName="TAPE_IMBALANCE_RATE_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=1; sc.GraphRegion=0; sc.ValueFormat=26; sc.MaintainTimeAndSalesData=1; sc.FreeDLL=0;
  ...
  sc.Subgraph[1][sc.ArraySize-1]=(buy-sell)/(double)win;
}
