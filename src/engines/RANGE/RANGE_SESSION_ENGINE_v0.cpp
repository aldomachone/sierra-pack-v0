...
SCSFExport scsf_RANGE_SESSION_ENGINE_v0(SCStudyInterfaceRef sc)
{
  if(sc.SetDefaults){
    sc.GraphName="RANGE_SESSION_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=0; sc.GraphRegion=0; sc.ValueFormat=26; sc.FreeDLL=0;
    ...
    sc.Input[0].Name="01. Lookback barres"; sc.Input[0].SetInt(60); sc.Input[0].SetIntLimits(1,200000);
