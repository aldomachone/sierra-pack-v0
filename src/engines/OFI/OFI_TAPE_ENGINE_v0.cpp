...
SCSFExport scsf_OFI_TAPE_ENGINE_v0(SCStudyInterfaceRef sc)
{
  if(sc.SetDefaults){
    sc.GraphName="OFI_TAPE_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=1; sc.GraphRegion=0; sc.ValueFormat=26; sc.FreeDLL=0; sc.MaintainTimeAndSalesData=1;
    ...
    sc.Input[0].Name="01. Fenêtre ms"; sc.Input[0].SetInt(500); sc.Input[0].SetIntLimits(50,10000);
  ...
  int idx=sc.ArraySize-1; sc.Subgraph[1][idx]=buy-sell; sc.Subgraph[2][idx]=buy; sc.Subgraph[3][idx]=sell;
}
