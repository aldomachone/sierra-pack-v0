...
SCSFExport scsf_OFI_ENGINE_v0(SCStudyInterfaceRef sc)
{
  ...
  if(sc.SetDefaults){
    sc.GraphName="OFI_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=1; sc.GraphRegion=0; sc.ValueFormat=26; sc.UsesMarketDepthData=1; sc.FreeDLL=0;
  ...
  s_MarketDepthEntry md{}; int N=sc.Input[0].GetInt(); double b=0,a=0;
