...
SCSFExport scsf_DOM_IMBAL_SWEEP_ENGINE_v0(SCStudyInterfaceRef sc)
{
  ...
  if(sc.SetDefaults){
    sc.GraphName="DOM_IMBAL_SWEEP_ENGINE_v0"; sc.AutoLoop=0; sc.UpdateAlways=1; sc.GraphRegion=0; sc.ValueFormat=26; sc.UsesMarketDepthData=1; sc.FreeDLL=0;
  ...
  double imb = (b+aQ>0? (b-aQ)/(b+aQ):0.0);
  e = a*imb + (1-a)*e;
