...
SCSFExport scsf_OHLC_LEVELS_ENGINE_v0(SCStudyInterfaceRef sc)
{
  if(sc.SetDefaults)
  {
    sc.GraphName="OHLC_LEVELS_ENGINE_v0";
    ...
    sc.Input[0].Name="01. Décalage jours";
    sc.Input[0].SetInt(0); sc.Input[0].SetIntLimits(0,30);
  ...
  // Placeholder: niveaux de la barre courante (ou J-Offset si séries daily)
